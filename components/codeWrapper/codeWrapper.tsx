  ...
  return (
    <pre className="text-white w-[650px] border-2 border-[#333] pt-2 text-[16px] font-thin rounded-xl">
      <nav className="block">
        ...
        <div className="">
          <span className="bg-[#222] p-2 rounded-lg ml-8">my_profile.js </span>
        </div>
      </nav>
      <div className="bg-[#222] mt-0">
        ...
        <span className="block">
          <span className="inline-block mr-8 ml-2">8</span>
        ...
        <span className="block">
          <span className="inline-block mr-16 ml-2">12</span>
          <span className="text-[#F4C430]">console.</span>
          <span className="text-[#89ddff]">log</span>
          <span>(</span>
          <span className="text-[#a5e844]">'Vola! found perfect match!!'</span>
          <span>)</span>
        </span>
        <span className="block">
          <span className="inline-block ml-2">13</span>
        </span>
        <span className="block">
