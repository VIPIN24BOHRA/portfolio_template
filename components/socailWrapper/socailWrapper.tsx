...
import SocailLinkEffect from "../Animation/SocialAnimateEffect";
export default function SocialWrapper() {
  return (
    <div className="hidden sm:block fixed bottom-10 left-10">
      <ul>
        <SocailLinkEffect delay={0.1}>
